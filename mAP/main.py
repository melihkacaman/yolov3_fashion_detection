...
my_path_to_txt_files = os.path.join(os.getcwd(), 'data/ground_truth/*.txt')
print('my_path_to_txt_files is : ', my_path_to_txt_files)
ground_truth_files_list = glob.glob(my_path_to_txt_files)
if len(ground_truth_files_list) == 0:
  error(f"Error: No ground-truth files found inside path : {ground_truth_files_list}")
...
for txt_file in ground_truth_files_list:
  ...
  path_to_txt_file = os.path.join(os.getcwd(), 'data/predicted/' + file_id + ".txt")
  #print('path_to_txt_file : ', path_to_txt_file)
...
predicted_files_list = glob.glob(os.path.join(os.getcwd(), 'data/predicted/*.txt'))
...
for class_index, class_name in enumerate(gt_classes):
  ...
  for txt_file in predicted_files_list:
    ...
    file_id = os.path.basename(os.path.normpath(file_id))
    if class_index == 0:
      if not os.path.exists(os.path.join(os.getcwd(), 'data/ground_truth/' + file_id + ".txt")):
...
print('predicted_files_list: ', predicted_files_list)
for txt_file in predicted_files_list:
  # get lines to list
  lines_list = file_lines_to_list(txt_file)
  for line in lines_list:
